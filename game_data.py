...
class TileData:
    ...
    tile_type: int  # 0: door, 1: NPC, 2: Enemy
    tile_data: object()  # Data for the tile (Enemy / NPC / door), passed to processing
...
class MainMap:  # Main starting area Map
    ...
    def __init__(self):
        ...
        self.door_data = [DoorData(0, 1, chr(127), "-", Fore.BLUE, Fore.GREEN, True, [(9, 25)])]
        self.map_array = [["-", "-", "-", "-", "-", "-", "-", "-", "-", "1", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "", "", ""],
                     ["-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "", "", "", ""],
                     ["-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "", "", "", "", ""],
                     ["-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "", "", "", "", "", "", ""],
...
class Floor0:
    ...
    def __init__(self):
        ...
        self.npc = []  # NPC DATA [NEED TO WORK ON]
        self.enemy = None  # No enemies can spawn on this map
        self.door_data = [DoorData(1, 0, chr(127), "-", Fore.BLUE, Fore.GREEN, False, [(9, 9)])]
        self.map_array = [
            ["", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""],
            ["", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""],
            ["", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""],
