...
class StaticData:  # Core Game Data
    ...
    def __init__(self):
        ...
        self.enemies = [
            ...
            EnemyData(6, 'Reaper', 24, 8, 'R', Fore.CYAN, [AttackData('Slash', range(12, 15)),
                                                           AttackData('Death Incarnate', range(20, 25))], (9, 10),
                      loot_table=LootTables.high_level, move=True, loot_range=range(2, 5)),
            EnemyData(7, 'Giant', 20, 10, 'G', Fore.CYAN, [AttackData('Rock Throw', range(14, 22)),
                                                           AttackData('Tree Javelin', range(15, 22))], (10, 13),
                      loot_table=LootTables.high_level, move=True, loot_range=range(2, 5)),
            EnemyData(8, 'Gate Keeper', 100, 30, '╬', Fore.RED, [AttackData('Opera Singer Summons', range(30, 50)),
            ...
            EnemyData(9, 'Pozzebun', 110, 25, 'Д', Fore.BLUE, [AttackData('Opera Singer Summons', range(30, 50)),
                                                               AttackData('Pop Quiz', range(40, 45)),
...
class Floor2:  # Gate Keeper's Floor
    __slots__ = ('map_name', 'map_array', 'map_desc', 'npc', 'enemy', 'map_id', 'door_data')
...
class Floor3:  # Gate Keeper's Floor
    __slots__ = ('map_name', 'map_array', 'map_desc', 'npc', 'enemy', 'map_id', 'door_data')
